    ...
    <section className="py-10 lg:py-12 bg-[#0A0A0A]">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <a href={siteConfig.social.instagram.url} target="_blank" rel="noopener noreferrer" className="bg-white/5 backdrop-blur-xl rounded-xl px-5 py-4 lg:px-6 lg:py-5 flex items-center gap-3 lg:gap-4 border border-white/10 hover:border-white/20 transition-all duration-300 group cursor-pointer shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_40px_rgba(217,4,41,0.1)] hover:-translate-y-0.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs lg:text-sm text-gray-300">{siteConfig.social.instagram.handle}</p>
          ...
          <a href={siteConfig.social.linkedin.url} target="_blank" rel="noopener noreferrer" className="bg-white/5 backdrop-blur-xl rounded-xl px-5 py-4 lg:px-6 lg:py-5 flex items-center gap-3 lg:gap-4 border border-white/10 hover:border-white/20 transition-all duration-300 group cursor-pointer shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_12px_40px_rgba(217,4,41,0.1)] hover:-translate-y-0.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs lg:text-sm text-gray-300">{siteConfig.social.linkedin.name}</p>
