...
const translations = {
  en: {
    ...
    "about.description": "HCS Trading LLC is dedicated to providing reliable electronics and global supply solutions for businesses across the Americas. Through strategic partnerships, efficient distribution channels, and a commitment to operational excellence, we help connect international brands with growing markets while delivering dependable service and long-term business value. Our mission is to strengthen global business relationships through trust, efficiency, and innovative supply solutions tailored to evolving market demands.",
  ...
  es: {
    ...
    "about.description": "HCS Trading LLC se dedica a proporcionar soluciones confiables de electrónica y suministro global para empresas en las Américas. A través de alianzas estratégicas, canales de distribución eficientes y un compromiso con la excelencia operativa, ayudamos a conectar marcas internacionales con mercados en crecimiento, entregando un servicio confiable y valor comercial a largo plazo. Nuestra misión es fortalecer las relaciones comerciales globales a través de la confianza, la eficiencia y soluciones de suministro innovadoras adaptadas a las demandas cambiantes del mercado.",
