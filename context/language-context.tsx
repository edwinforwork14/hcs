...
const translations = {
  en: {
    ...
    // Chat auth
    "chat.auth.title": "Sign in to chat",
    "chat.auth.subtitle": "Create an account or sign in to start a conversation.",
    "chat.auth.tabSignIn": "Sign In",
    "chat.auth.tabSignUp": "Sign Up",
    ...
    "chat.auth.accountExists": "Account already exists. Please sign in.",
    "chat.auth.signupDisabled": "Sign-ups are currently disabled.",
    "chat.auth.rateLimit": "Too many attempts. Please try again later.",
    "chat.auth.invalidCredentials": "Invalid email or password.",
    "chat.auth.signUpFailed": "Could not create account.",
    "chat.auth.confirmationRequired": "Please check your email to confirm your account.",
    "chat.auth.resendConfirmation": "Resend confirmation email",
    "chat.auth.confirmationSent": "Confirmation email sent!",
    "chat.auth.resendFailed": "Could not resend confirmation email.",
  ...
  es: {
    ...
    // Chat auth (es)
    "chat.auth.title": "Inicia sesión para chatear",
    "chat.auth.subtitle": "Crea una cuenta o inicia sesión para comenzar una conversación.",
    "chat.auth.tabSignIn": "Iniciar Sesión",
    "chat.auth.tabSignUp": "Registrarse",
    ...
    "chat.auth.signUp": "Registrarse",
    "chat.auth.signingIn": "Iniciando sesión...",
    "chat.auth.signingUp": "Creando cuenta...",
    "chat.auth.accountExists": "La cuenta ya existe. Por favor inicia sesión.",
    "chat.auth.signupDisabled": "Los registros están deshabilitados actualmente.",
    "chat.auth.rateLimit": "Demasiados intentos. Por favor intenta más tarde.",
    "chat.auth.invalidCredentials": "Correo o contraseña incorrectos.",
    "chat.auth.signUpFailed": "No se pudo crear la cuenta.",
    "chat.auth.confirmationRequired": "Por favor revisa tu correo para confirmar tu cuenta.",
    "chat.auth.resendConfirmation": "Reenviar correo de confirmación",
    "chat.auth.confirmationSent": "¡Correo de confirmación enviado!",
    "chat.auth.resendFailed": "No se pudo reenviar el correo de confirmación.",
